...
const idealWeight = document.querySelector("#ideal-weight span");
...
calcBtn.addEventListener("click", (e) => {
  ...
  const pesoIdealMin = (18.5 * (height * height)).toFixed(1);
  const pesoIdealMax = (24.9 * (height * height)).toFixed(1);

  // Exibir resultado
  imcNumber.innerText = imc;
  imcInfo.innerText = info;
  idealWeight.innerText = `${pesoIdealMin}kg a ${pesoIdealMax}kg`;
